            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (validationErrors?.["project-select"])
                    onClearError("project-select");
                }}
                className={`w-full max-w-md rounded-xl border bg-white px-3 py-2 text-sm text-gray-800 ${validationErrors?.["project-select"] ? "border-red-500 ring-1 ring-red-500" : "border-gray-200"}`}
              >
              ...
              <div className="flex-1">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    if (validationErrors?.["category-select"])
                      onClearError("category-select");
                  }}
                  className={`w-full rounded-xl border bg-white px-3 py-2 text-sm text-gray-800 ${validationErrors?.["category-select"] ? "border-red-500 ring-1 ring-red-500" : "border-gray-200"}`}
