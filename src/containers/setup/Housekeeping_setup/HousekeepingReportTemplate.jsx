...
function HousekeepingReportTemplate({
  excelData,
  sheetName,
  selectedQuestions,
        ...
        <table className="w-full text-sm border-collapse mb-6">
          <thead>
            <tr className="bg-foreground/5">
              <th className="border border-gray-200 px-3 py-2 text-left font-semibold" style={{ width: "35%" }}>
                Checklist Points
              </th>
              <th className="border border-gray-200 px-3 py-2 text-center font-semibold" style={{ width: "10%" }}>
                Yes
              </th>
              <th className="border border-gray-200 px-3 py-2 text-center font-semibold" style={{ width: "10%" }}>
                No
              ...
              <th className="border border-gray-200 px-3 py-2 text-center font-semibold" style={{ width: "15%" }}>
                Images
              </th>
              <th className="border border-gray-200 px-3 py-2 text-center font-semibold" style={{ width: "20%" }}>
                Remark
              </th>
            </tr>
          </thead>
              ...
              <tr key={ri} className="hover:bg-gray-50/50 transition-colors">
                ...
                <td className="border border-gray-200 px-3 py-2 text-center text-gray-900">
                  {isEditMode ? (
                    <input
                      value={row.yes}
                      onChange={(e) => setChecklistRow(ri, "yes", e.target.value)}
                ...
                <td className="border border-gray-200 px-3 py-2 text-center text-gray-900">
                  {isEditMode ? (
                    <input
                      value={row.no}
                      onChange={(e) => setChecklistRow(ri, "no", e.target.value)}
                      className="w-full border border-gray-200 px-2 py-1 text-center text-sm outline-none focus:border-orange-500"
                      placeholder="✓"
                    />
                  ) : (
                ...
                <td className="border border-gray-200 px-3 py-2 text-center text-gray-900">
                  {isEditMode ? (
                    <input
                      value={row.na}
                      onChange={(e) => setChecklistRow(ri, "na", e.target.value)}
                      className="w-full border border-gray-200 px-2 py-1 text-center text-sm outline-none focus:border-orange-500"
                      placeholder="✓"
                    />
                  ) : (
                ...
                <td className="border border-gray-200 px-3 py-2 text-center text-gray-900">
                  {isEditMode ? (
                    <input
                      value={row.image}
                      onChange={(e) => setChecklistRow(ri, "image", e.target.value)}
                      className="w-full border border-gray-200 px-2 py-1 text-center text-sm outline-none focus:border-orange-500"
                      placeholder="Image"
                    />
                  ) : (
...
export default HousekeepingReportTemplate;