...
import {
    listHousekeepingTemplates,
    deleteHousekeepingTemplate,
    getProjectsForCurrentUser,
    getHousekeepingTemplate,
} from "../../../api";
...
function HousekeepingFormats() {
    ...
    const fetchTemplates = async () => {
        ...
        setError(null);
        try {
            const res = await listHousekeepingTemplates({ 
                org_id: orgId,
    ...
    const handleCreate = () => {
        navigate("/housekeepingSetup/create");
    };
    ...
    const handleDelete = async (e, template) => {
        ...
        setDeletingId(id);
        try {
            await deleteHousekeepingTemplate(id);
...
export default HousekeepingFormats;
