...
const DEFAULT_ROLE_ELEMENT = <PermitCheckerDashboard />;
...
export default function UserPermitDashboard() {
    ...
    useEffect(() => {
        ...
        // we default to checker for now until backend user-group mapping logic is fully implemented on frontend
        setRole("checker");
        setResolved(true);
    }, [role]);
