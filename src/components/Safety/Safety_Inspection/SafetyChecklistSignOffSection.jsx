...
import { X, Eye, UserRound, ShieldCheck, Signature } from "lucide-react";
    ...
    <>
      <div className={`rounded-xl border bg-card p-5 shadow-sm ${className}`}>
        ...
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
          <SignOffRow user={users.maker} onView={setSignatureUser} />

          <SignOffRow user={users.checker} onView={setSignatureUser} />
        </div>
      </div>
