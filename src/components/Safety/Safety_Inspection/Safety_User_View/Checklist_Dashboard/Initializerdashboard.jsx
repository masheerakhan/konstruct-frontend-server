...
const resolveMediaUrl = (path) => {
  ...
  return `${import.meta.env.VITE_CHECKLIST_URL}${cleanPath}`;
};
      ...
      <div className="min-h-screen bg-muted/40 p-4 sm:p-6 md:p-10">
        <div className="mx-auto max-w-4xl">
          ...
          {detail.template_instruction_image && (
            <div className="mb-6 rounded-xl border bg-card p-5 shadow-sm flex flex-col items-center justify-center">
              <img
        ...
        <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
          {Object.keys(COUNTER_META).map((key) => {
            ...
            return (
              <div
                key={key}
                className="flex-1 min-w-0 rounded-xl border border-border bg-card p-5 shadow-sm"
              >
