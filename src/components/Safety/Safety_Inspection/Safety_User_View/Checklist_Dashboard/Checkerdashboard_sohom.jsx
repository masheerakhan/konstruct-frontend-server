...
import { approveSafetyChecklist, getSafetyChecklist, listSafetyChecklists, rejectSafetyChecklist, resolveActiveProjectId, downloadSafetyReport, downloadSafetyObservationReport, submitSafetyChecklist, listSafetyObservations, getSafetyObservationById } from "../../../../../api";
...
export default function CheckerDashboard() {
    ...
    const wingOptions = ["A", "B", "C", "D", "E", "F", "G"];
                                ...
                                <section>
                                    ...
                                    <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
                                        {(isObservations ? [
                                            ...
                                            {
                                                key: "total",
                                                label: "Total Raise Observations",
