...
export default function QualitySignages({
    rows = [],
    loading = false,
    onView,
    onFormOpenChange,
                ...
                <div className="flex flex-wrap items-start justify-between gap-4">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            Track and manage Quality Signages across the project.
                        </p>
                    </div>
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 border-b border-gray-100 px-5 py-4">
                    <div className="relative min-w-[280px] flex-1">
                        ...
                        <input
                            ...
                            placeholder="Search Quality Signages..."
                            ...
                            {loading ? (
                                <tr>
                                    <td colSpan={7} className="px-4 py-10 text-center text-gray-400">
                                        Loading Quality Signages...
                                    </td>
                                </tr>
                            ) : filteredRows.length === 0 ? (
                                <tr>
                                    <td colSpan={7} className="px-4 py-10 text-center text-gray-400">
                                        No Quality Signages records found. Click Create Signage to add a new record.
                                    </td>
                                </tr>
                            ) : (
