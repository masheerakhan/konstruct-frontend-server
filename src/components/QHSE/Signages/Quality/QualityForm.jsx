...
const cardCls = "rounded-2xl border border-gray-200 bg-white p-5 shadow-sm md:p-6";

export default function QualityForm({ onCancel, onSuccess }) {
  ...
  const handleSubmit = (e) => {
    ...
    toast.success("Quality Signage successfully saved!");
    onSuccess?.({
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <section className={cardCls}>
            <div className="flex items-center justify-between">
              ...
              {markers.length > 0 && (
                <button
                  ...
                  className="inline-flex h-8 items-center gap-2 rounded-md bg-white border border-orange-200 px-3 text-xs font-medium text-orange-600 hover:bg-orange-50 shadow-sm transition"
                >
            ...
            {!selectedPlan ? (
              ...
              <div className="rounded-xl border border-orange-100 bg-white p-6 flex flex-col items-center justify-center text-center">
                ...
                <button
                  type="button"
                  onClick={() => setShowAnnotationModal(true)}
                  className="inline-flex h-10 items-center gap-2 rounded-md bg-orange-500 px-6 text-sm font-medium text-white hover:bg-orange-600 shadow-sm transition"
                >
