...
const blankRow = (idx) => ({
  recordNo: `HIPPL-XXX-YYY-QUA-TRI-${String(idx).padStart(2, "0")}`,
  topic: "",
  trade: "",
  dateConducted: "",
  toAgency: "",
...
const TrainingQualityRegister = () => {
  ...
  const title = "Training Record Register - Quality";
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="bg-white rounded-md shadow-sm border border-slate-200">
          <div className="bg-sky-700 text-white px-4 py-2 font-semibold text-sm rounded-t-md flex items-center justify-between">
            <span>Quality Training Entries</span>
            <button
              type="button"
              onClick={addRow}
        ...
        <div className="flex justify-end gap-3 mt-5">
          ...
          <button
            type="button"
            onClick={() => alert("Quality Training Register saved!")}
...
export default TrainingQualityRegister;
