...
export default function MaterialChecklist({
  ...
  const fullSystemDocCols = [
    {
      key: "technicalData",
      header: "Technical data sheet / Product catalogue",
    },
    {
      key: "manufacturerTest",
      header: "Manufacturer test certificate",
    },
    {
      key: "thirdPartyTest",
      header: "3rd party test certificate",
    },
  ];
