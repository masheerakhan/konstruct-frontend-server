        ...
        <table className="w-full text-xs border-collapse min-w-[720px]">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              <th className="text-center font-semibold text-gray-700 px-2 py-2 w-12 whitespace-nowrap">
                {capitalCase("sl")}
              </th>
              <th className="text-left font-semibold text-gray-700 px-2 py-2 min-w-[220px]">
                {capitalCase("document / details required")}
              </th>
              <th className="text-center font-semibold text-gray-700 px-2 py-2 pl-6 w-[200px] whitespace-nowrap">
                {capitalCase("annexure")}
              </th>
              <th className="text-center font-semibold text-gray-700 px-2 py-2 min-w-[140px]">
                {capitalCase("remarks")}
              </th>
