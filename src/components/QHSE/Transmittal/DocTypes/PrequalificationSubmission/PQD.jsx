        ...
        <table className="w-full text-xs border-collapse min-w-[720px]">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              ...
              <th className="text-left font-semibold text-gray-700 px-2 py-2 w-44 whitespace-nowrap">
                {capitalCase("status")}
              </th>
              <th className="text-left font-semibold text-gray-700 px-2 py-2 w-32 whitespace-nowrap">
            ...
            {(rows || []).map((row) => {
              ...
              return (
                <tr key={row.id} className="border-b border-gray-100 last:border-0">
                  <td className="px-2 py-2 text-center tabular-nums text-gray-800" style={{ verticalAlign: "top" }}>{row.slNo}</td>
                  <td className="px-2 py-2 text-gray-900 leading-snug" style={{ verticalAlign: "top" }}>
                    <AutoResizeTextarea
                      className="w-full min-h-[52px] text-[11px] rounded-md border border-gray-200 bg-white px-2 py-1.5 text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
                      value={row.document ?? ""}
                  ...
                  <td className="px-2 py-2" style={{ verticalAlign: "top" }}>
                    <AutoResizeTextarea
                      className="w-full min-h-[52px] text-xs rounded-md border border-gray-200 bg-white px-2 py-1.5 text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
                      value={row.remarks ?? ""}
                      onChange={(e) => patchRow(row.id, { remarks: e.target.value })}
                      placeholder={capitalCase("remarks")}
                    />
                  </td>
                  <td className="px-1 py-2" style={{ verticalAlign: "top" }}>
                    {isCustom ? (
                      <button
                        type="button"
